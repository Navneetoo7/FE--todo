...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default: "border-transparent bg-purple-100 text-purple-800 hover:bg-purple-200/80",
        secondary: "border-transparent bg-blue-100 text-blue-800 hover:bg-blue-200/80",
        destructive: "border-transparent bg-red-100 text-red-800 hover:bg-red-200/80",
        outline: "text-foreground border border-gray-300 bg-white hover:bg-gray-100",
